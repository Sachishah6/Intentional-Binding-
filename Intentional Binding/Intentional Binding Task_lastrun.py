...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\Documents\\psy310 lab in psyc\\Intentional Binding\\Intentional Binding Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('ib_cons.xlsx'),
    ...
    # completed 33.0 repeats of 'trials'
